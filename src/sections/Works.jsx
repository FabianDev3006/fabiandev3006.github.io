...
const Works = () => {
  ...
  const text = `Showcasing My Projects and Contributions in Backend Development`;
  ...
  return (
    <section id="projects" className="flex flex-col min-h-screen">
      <AnimatedHeaderSection
        subTitle={"Discover My Journey Through Real-World Projects"}
        title={"My Work"}
        text={text}
      ...
      >
        {projects.map((project, index) => (
          <div
            ...
            onClick={() => handleProjectClick(project)} // Add click handler here
          >
            {/* overlay */}
            <div
              ref={(el) => {
