...
const Navbar = () => {
  ...
  useGSAP(() => {
    ...
    gsap.set([topLineRef.current, bottomLineRef.current], { transformOrigin: "center" });
  ...
  return (
    <>
      ...
      >
        ...
        <div ref={contactRef} className="flex flex-col flex-wrap justify-between gap-8 md:flex-row">
          <div className="font-light">
            ...
            <p className="text-xl tracking-widest lowercase text-pretty">Fabianthamm99@outlook.de</p>
          </div>
        </div>
      ...
      <div
        className="fixed z-50 flex flex-col items-center justify-center gap-1 transition-all duration-300 bg-black rounded-full cursor-pointer w-14 h-14 md:w-20 top-4 right-10"
        onClick={toggleMenu}
        style={
            showBurger
            ? { clipPath: "circle(50% at 50% 50%)", WebkitClipPath: "circle(50% at 50% 50%)" }
